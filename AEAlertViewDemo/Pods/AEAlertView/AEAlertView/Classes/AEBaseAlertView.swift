...
class AEBaseAlertView: UIView {
    ...
    private func commonInit() {
        ...
        alertBackgroundView.addConstraints(
            NSLayoutConstraint.constraints(withVisualFormat:
                "V:|-35@750-[titleLabel]-5@750-[messageTextView]-25@750-[contentViewContainerView]-25@750-[actionButtonContainerView]-(13@750)-|", options: NSLayoutConstraint.FormatOptions(rawValue: 0), metrics: nil, views: ["titleLabel":titleLabel as Any, "messageTextView":messageTextView as Any, "contentViewContainerView":contentViewContainerView as Any, "actionButtonContainerView":actionButtonContainerView as Any]))
    }
